<?php
    ...
    if(!mysqli_num_rows($result)) {
        $result = mysqli_query($conn, "INSERT INTO `guests` (`guest_id`, `guest_date`, `guest_ip_addr`, `guest_info`, `guest_status`) VALUES ('$guest_id', NULL, '$guest_ip_addr', '$guest_info', 'Unverified')");
    }
